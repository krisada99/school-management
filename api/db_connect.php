...
$serverName = "localhost";    // โดยทั่วไปคือ "localhost" หรือ "127.0.0.1"
$database   = "school_db";   // !!! เปลี่ยนชื่อฐานข้อมูลที่คุณจะสร้าง (เช่น school_db)
$uid        = "root";     // !!! ชื่อผู้ใช้ฐานข้อมูลของคุณ (อาจไม่ใช่ root ใน production)
$pwd        = "CTC@dmin01"; // !!! รหัสผ่านที่คุณตั้งไว้สำหรับผู้ใช้ฐานข้อมูล
